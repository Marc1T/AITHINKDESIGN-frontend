      ...
      <CardContent className="space-y-6 pt-6">
        ...
        {phase === 'selection' && (
          <>
            <div className="space-y-4">
              <h3 className="font-semibold">🏆 Choisissez l'Idée Finale</h3>
            ...
            <div className="space-y-2">
              <label className="font-medium">💬 Justification (optionnel)</label>
              <Textarea
            ...
            >
              {isConfirming ? '⏳ Génération...' : '📄 Générer le Cahier de Charge'}
            </Button>
          </>
        )}
        ...
        {phase === 'result' && (
          <>
            ...
            {selectedIdea && (
              <div className="p-4 rounded-lg border bg-primary/5">
                <h4 className="font-medium mb-2">🏆 Idée Retenue</h4>
            ...
            {/* Workshop Summary */}
            <div className="space-y-4">
              <h4 className="font-semibold">📋 Résumé du Workshop</h4>

              <div className="grid grid-cols-2 gap-3">
                <div className="p-4 rounded-lg border">
                  <h5 className="font-medium mb-2">📝 Contexte</h5>
                ...
                <div className="p-4 rounded-lg border">
                  <h5 className="font-medium mb-2">🏆 Concept Final</h5>
                  <p className="text-sm text-muted-foreground">
            ...
            <div className="p-4 rounded-lg bg-muted/50">
              <h4 className="font-medium mb-3">📊 Statistiques du Workshop</h4>
